...
echo 'net.ipv4.ip_local_reserved_ports = 80-32767' >> /etc/sysctl.conf
...
sed -r -i  "s@#{0,}?net.ipv4.ip_local_reserved_ports ?= ?([0-9]{1,}-{0,1},{0,1}){1,}@net.ipv4.ip_local_reserved_ports = 80-32767@g" /etc/sysctl.conf
