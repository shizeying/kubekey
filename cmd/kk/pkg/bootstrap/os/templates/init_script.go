...
echo 'net.ipv4.ip_local_reserved_ports = 1-65535' >> /etc/sysctl.conf
...
sed -r -i  "s@#{0,}?net.ipv4.ip_local_reserved_ports ?= ?([0-9]{1,}-{0,1},{0,1}){1,}@net.ipv4.ip_local_reserved_ports = 1-65535@g" /etc/sysctl.conf
